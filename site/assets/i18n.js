...
export const UI_STRINGS = {
  ro: {
    ...
    previewTitle: (restNights) => restNights > 1 ? 'Pauză câteva nopți — ce urmează' : 'Pauză la noapte — ce urmează',
    previewRestNote: (label) => `La noapte nu se joacă; următoarele meciuri sunt ${label}.`,
    ...
    afterExtraTime: 'după prelungiri',
    afterPenalties: 'după penalty-uri',
  ...
  en: {
    ...
    previewTitle: (restNights) => restNights > 1 ? 'A few nights off — next up' : 'Rest night tonight — next up',
    previewRestNote: (label) => `No matches tonight; the next fixtures are on ${label}.`,
